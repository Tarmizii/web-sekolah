...
import { Target, Compass, BookOpen, Users, Globe, Award } from 'lucide-react';

const VisiMisi: React.FC = () => {
  const missions = [
    {
      icon: <BookOpen size={24} />,
      text: "Menyelenggarakan pendidikan yang berkualitas, inovatif, dan relevan dengan perkembangan zaman."
    },
    {
      icon: <Users size={24} />,
      text: "Membentuk karakter siswa yang berakhlak mulia, disiplin, dan bertanggung jawab."
    },
    {
      icon: <Globe size={24} />,
      text: "Mengembangkan wawasan global dan kemampuan adaptasi teknologi pada seluruh civitas akademika."
    },
    {
      icon: <Target size={24} />,
      text: "Mengoptimalkan potensi akademik dan non-akademik siswa melalui pembinaan intensif."
    },
    {
      icon: <Compass size={24} />,
      text: "Mewujudkan lingkungan sekolah yang asri, aman, dan kondusif untuk kegiatan belajar mengajar."
    },
    {
      icon: <Award size={24} />,
      text: "Meningkatkan prestasi sekolah di tingkat regional, nasional, hingga internasional."
    }
  ];
    ...
    <div className="min-h-screen pt-32 pb-24 bg-surface">
      <div className="container mx-auto px-6 space-y-12">
        ...
        <section className="bg-white p-12 rounded-[2.5rem] border border-gray-100 shadow-sm text-center relative overflow-hidden">
            ...
            <p className="font-serif text-3xl md:text-5xl lg:text-6xl text-gray-900 leading-tight max-w-5xl mx-auto">
                "Terwujudnya insan cendekia yang beriman, berilmu, dan berbudaya lingkungan serta mampu bersaing di era global."
            </p>
        </section>
