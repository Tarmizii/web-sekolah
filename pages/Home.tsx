                ...
                <div className="relative z-10 flex flex-col justify-center h-full">
                    <div className="mb-8">
                        ...
                        <h1 className="font-serif text-4xl md:text-5xl lg:text-7xl font-bold leading-[1.1] mb-8 tracking-tight">
                            Unggul dalam Iman, <br/>
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-400">Cerdas dalam Ilmu.</span>
                        </h1>
                        <p className="text-gray-300 text-lg md:text-xl max-w-xl leading-relaxed font-normal">
                            Institusi pendidikan yang mengedepankan integritas akademik dan pembentukan karakter mulia untuk mencetak pemimpin masa depan.
                        </p>
                    </div>
                ...
                <div className="flex-grow bg-gray-100 rounded-[2.5rem] overflow-hidden relative min-h-[300px] group">
                    ...
                    />
                     ...
                     <div className="absolute bottom-6 left-6 right-6">
                        ...
                        <p className="text-white font-serif text-xl italic leading-snug">"Lingkungan yang mendukung potensi siswa."</p>
                     </div>
                </div>
                ...
                <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 flex items-center justify-between shadow-sm hover:shadow-md transition-shadow">
                     <div>
                        <div className="flex items-baseline gap-1">
                             <span className="text-4xl font-serif font-bold text-gray-900">98%</span>
                             <TrendingUp size={20} className="text-primary" />
                        </div>
                        <span className="text-sm text-gray-500 font-bold uppercase tracking-wide mt-1 block">Lulusan di PTN</span>
                     </div>
        ...
        <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="col-span-1 md:col-span-2 md:row-span-2 bg-white p-8 md:p-10 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col justify-center">
                     <span className="text-xs font-bold tracking-widest text-primary uppercase mb-4 block">Filosofi Kami</span>
                     <h3 className="font-serif text-2xl md:text-3xl text-gray-900 mb-6 leading-tight font-bold">
                        Membangun karakter mulia dengan fondasi akademik yang kokoh.
                     </h3>
                     <p className="text-gray-600 leading-relaxed mb-8 flex-grow">
                        SMA Swasta Al-Hikmah berkomitmen menciptakan lingkungan belajar yang inklusif dan progresif. Kami memadukan nilai-nilai tradisional dengan metodologi pengajaran modern untuk mencetak pemimpin masa depan.
                     </p>
                     <div className="flex items-center gap-4 pt-4 border-t border-gray-100">
                        <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center">
                            <span className="font-serif font-bold text-gray-600">25</span>
                        </div>
                        <span className="text-sm text-gray-500 font-bold">Tahun Pengabdian</span>
                     </div>
                </div>
